					...
					<div class="row">
						...
						<div class="col-sm-8 col-xs-12">
							<div class="details">
								...
								{
								?>
									<span class="listing-price"><?php echo $this->texts["price_for"];?> <?php echo $number_nights;?> <?php echo $this->texts["nights"];?>: <strong><?php echo $this->settings["website"]["currency"].number_format($listing->price * $number_nights,2,'.','');?></strong></span>
									<br/>
									<span class="listing-price"><?php echo $this->texts["price"];?>: <strong><?php echo $this->settings["website"]["currency"].number_format(floatval($listing->price),2,'.','');?></strong></span>
								<?php
								}
								?>
